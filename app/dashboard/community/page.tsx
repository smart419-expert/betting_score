  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[89.7vh] bg-[#1b1d1e] text-center text-white">
        ...
        <p className="text-gray-600 max-w-md mb-4">Join the Gambino community, chat with other members, and participate in discussions, groups, and live events.</p>
